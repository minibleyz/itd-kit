...
**itd-kit** — компонентная база на React, вдохновлённая интерфейсом социальной сети ИТД. Все стили задаются прямо в JSX через inline-объекты, цвета управляются через дизайн-токены с поддержкой светлой и тёмной темы.
